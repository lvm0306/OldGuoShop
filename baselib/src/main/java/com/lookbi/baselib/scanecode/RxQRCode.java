...
import com.lookbi.baselib.utils.ImageUtil;
...
public class RxQRCode {
    ...
    public static Bitmap creatQRCode(CharSequence content, int QR_WIDTH, int QR_HEIGHT) {
        return creatQRCode(content, QR_WIDTH, QR_HEIGHT, -1, 0xff000000);
    }
    public static Bitmap creatQRCode(CharSequence content, int QR_WIDTH, int QR_HEIGHT,int backgroundColor) {
        return creatQRCode(content, QR_WIDTH, QR_HEIGHT, backgroundColor, 0xff000000);
    }
