...
public class CashierInputFilter implements InputFilter {
    ...
    private static boolean OUT_MAX_VALUE = false;//是否输出自定义的最大限值
    ...
    public CashierInputFilter(EditText et, double max_value, boolean out_max_value) {
        MAX_VALUE = max_value;
        ET = et;
