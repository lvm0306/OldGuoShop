...
//            String date = mMonth + "月" + mDay + "日";
     ...
     * @return
     */
    public static String[] formatIntToString(int l) {
        String[] strings = new String[]{"00", "00", "00", "00"};
//        l = l * 1000;
//        int days = l / (1000 * 60 * 60 * 24);
        int hours = (l % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60);
        int minutes = (l % (1000 * 60 * 60)) / (1000 * 60);
        int seconds = (l % (1000 * 60)) / 1000;
        int millseconds = l % 1000;
        strings[0] = (hours / 10) + "" + (hours % 10);
        strings[1] = minutes / 10 + "" + minutes % 10;
        strings[2] = seconds / 10 + "" + seconds % 10;
        int m = millseconds / 10;
        if (m < 10) {
            strings[3] = "0" + m;
        } else {
            strings[3] = "" + m;
