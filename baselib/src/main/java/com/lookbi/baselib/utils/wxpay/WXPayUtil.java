...
//        boolean isWXAppSupported=api.isWXAppSupportAPI();
//        Log.e("isWXAppInstalled",isWXAppInstalled+"..."+isWXAppSupported);
        if (!isWXAppInstalled){
            Toast.makeText(mcontext,"未安装微信，请先安装微信！", Toast.LENGTH_SHORT).show();
            return ;
        }
//        if (!isWXAppSupported){
//            Toast.makeText(mcontext,"请升级微信版本！", Toast.LENGTH_SHORT).show();
//            return ;
//        }
        req = new PayReq();
