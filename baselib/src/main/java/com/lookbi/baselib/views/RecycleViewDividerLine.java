...
/**
 * Created by zhengkq on 2017/5/5.
 */
...
public class RecycleViewDividerLine extends RecyclerView.ItemDecoration {
     ...
     */
    public RecycleViewDividerLine(Context context, int orientation) {
     ...
     */
    public RecycleViewDividerLine(Context context, int orientation, int drawableId) {
        this.setOrientation(orientation);
