 ...
 * @author: zhang.z.z
 * @date: 2017/12/7
 * @email: ITzhangzz@163.com
 * @Description:  y = A*sin(wx+b)+h 正弦函数
 */
public class DoubleWaveView extends View {
    ...
    public DoubleWaveView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mXOffsetSpeedOne = DensityUtil.dp2px(TRANSLATE_X_SPEED_ONE);
        mXOffsetSpeedTwo = DensityUtil.dp2px(TRANSLATE_X_SPEED_TWO);
